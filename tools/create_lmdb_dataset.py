...
if __name__ == '__main__':
    from tools.create_lmdb_dataset import get_datalist, createDataset

    data_dir = r"C:\Users\anhhu\lp_for_openocr\images"
    label_file = r"C:\Users\anhhu\lp_for_openocr\labels.txt"
    save_path_root = r"C:\Users\anhhu\lp_for_openocr\lmdb"

    train_data_list = get_datalist(data_dir, label_file, max_len=25)
    createDataset(train_data_list, save_path_root)
